...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="conformer_ctc/exp_finetune_orig",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.001,
        help="The lr for Adam optimizer",
    )

    parser.add_argument(
        "--pretrained-model",
        type=str,
        default="conformer_ctc/exp_semi-time_warp_factor0-bytes_per_frame4-cdweight1.0-predictorpredictor/epoch-1.pt",
