...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="conformer_ctc/exp_finetune_mpl",
...
def compute_semi_loss(
    ...
    model.train()
    nnet_output_1, _, _ = model(triple_feature[1].to(device), supervisions)
    ...
    nnet_output_2, _, _ = model(triple_feature[2].to(device), supervisions)
