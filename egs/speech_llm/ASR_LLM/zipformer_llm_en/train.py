...
"""
Train LLM-based ASR model that combines Zipformer speech encoder and Qwen2 LLM.
...
from model import IGNORE_TOKEN_ID, Speech_LLM_Zipformer, EncoderProjector
...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="large",
        help="Type of the speech encoder.",
    )

    parser.add_argument(
        "--speech-encoder-path",
        type=str,
        default="models/zipformer/librispeech/transducer_crctc_large/pretrained.pt",
        help="Path of the speech encoder.",
    )
    ...
    parser.add_argument(
        ...
        help="Path of the bpe model of the speech encoder.",
    )
