...
python3 ./zipformer_llm_en/decode.py \
  --max-duration 2000 \
...
from model import Speech_LLM_Zipformer, EncoderProjector
...
def decode_one_batch(
    ...
    messages = [
        [
            {
                "role": "user",
                "content": f"{START_SPEECH_TOKEN}{DEFAULT_SPEECH_TOKEN}{END_SPEECH_TOKEN}",
            },
